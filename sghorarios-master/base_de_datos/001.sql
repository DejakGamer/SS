...
INSERT INTO `auth_group` VALUES (2,'Coordinador'),(1,'Docente');
...
INSERT INTO `auth_group_permissions` VALUES (1,1,20),(2,1,21),(3,1,22),(4,1,23),(5,1,24),(6,2,20),(7,2,21),(8,2,22),(9,2,23),(10,2,24);
...
INSERT INTO `django_admin_log` VALUES (1,'2021-05-15 16:22:10.177220','1','Docente',1,'[{\"added\": {}}]',3,1),(2,'2021-05-15 16:22:35.266070','2','Coordinador',1,'[{\"added\": {}}]',3,1);
...
CREATE TABLE `horarios_horarios` (
  ...
  CONSTRAINT `horarios_horarios_grupo_id_8bd6289b_fk_horarios_grupo_siglas` FOREIGN KEY (`grupo_id`) REFERENCES `horarios_grupo` (`siglas`),
...
INSERT INTO `horarios_unidadaprendizaje` VALUES (1,'Elaboración de textos académicos',1,4,1),(2,'Antropología filosófica',1,4,1),(3,'Ética',1,4,1),(4,'Historia de la Filosofía griega clásica',1,4,1),(5,'Lógica tradicional',1,4,1),(6,'Pensamiento prehispánico',1,4,1),(7,'Inglés 8',5,4,1),(8,'Filosofía de la ciencia',5,4,1),(9,'Historia de la Filosofía del siglo VXII a mediados del XVIII',5,4,1),(10,'Filosofía en América Latina y el Caribe siglo XX',5,7,1),(11,'Filosofía política contemporánea',5,4,1),(12,'Análisis de textos filosóficos',5,4,1),(13,'Filosofía de la cultura',5,4,1),(14,'Filosofía de las ciencias de la vida',5,4,1),(15,'Monográfico temático o de autor Grecia y Roma',5,4,1),(16,'Filosofía de los pueblos originarios contemporáneos',5,4,1);
...
-- Dump completed on 2021-05-15 13:01:40
